...
export default function UploadReceiptPage() {
  ...
  const { data: nextInvoice, ...nextInvoiceData } = useGetNextInvoiceQuery(
    storage.get("token"),
    {
  ...
  const { data: currentInvoice, ...currentInvoiceData } =
    useGetInvoiceByIdQuery(
      ...
      {
        skip:
          !user.isSuccess || !user.user || params.get("invoice_id") === null,
      }
    );
  ...
  const invoice =
    params.get("invoice_id") !== null ? currentInvoice : nextInvoice;
  const isLoading =
    params.get("invoice_id") !== null
      ? currentInvoiceData.isLoading || currentInvoiceData.isUninitialized
      : nextInvoiceData.isLoading || nextInvoiceData.isUninitialized;
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <div className="flex justify-between items-center">
                          <div>
                            {dayjs(paidDate).format("DD MMMM YYYY h:mm A")}
                          </div>
