  ...
  return (
    <div className="relative flex size-full min-h-screen flex-col bg-base justify-between group/design-root overflow-x-hidden">
      ...
      <div>
        ...
        <div className="flex gap-2 border-t border-[var(--secondary)] bg-base px-4 pb-3 pt-2">
          <a
            className="just flex flex-1 flex-col items-center justify-end gap-1 rounded-lg text-[var(--secondary-text)]"
            href="#"
          >
            <div
              className="text-[var(--secondary-text)] flex h-8 items-center justify-center"
              data-icon="House"
              data-size="24px"
              data-weight="fill"
            >
            ...
            <p className="text-[var(--secondary-text)] text-xs font-medium leading-normal tracking-[0.015em]">
              Dashboard
            </p>
          </a>
          <a
            className="just flex flex-1 flex-col items-center justify-end gap-1 text-[var(--primary)]"
            href="#"
          >
            <div
              className="text-[var(--primary)] flex h-8 items-center justify-center"
              data-icon="Receipt"
              data-size="24px"
              data-weight="regular"
            >
            ...
            <p className="text-[var(--primary)] text-xs font-medium leading-normal tracking-[0.015em]">
              Invoices
            </p>
          </a>
          <a
